    ...
    def handle(self, *args, **opts):
        ...
        for e in esp_por_anio.get("2°", []):
            Correlatividad.objects.create(
                plan=plan, espacio=e, tipo="CURSAR", requisito="REGULARIZADA",
        ...
        self.stdout.write(self.style.SUCCESS("Correlatividades base cargadas. Ajustá y re-ejecutá si hace falta."))
